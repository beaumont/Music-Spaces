class RenameStreetProtocolProjectsToTpsContentAgain < ActiveRecord::Migration
  ...
  def self.up
    rename_class('TpsContent', 'Tps::Content')
    rename_class('TpsContentDetails', 'Tps::ContentDetails')
  end
