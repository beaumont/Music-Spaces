...
class ImageThumbnail < Content
    # :file_system_path => 'public/content/thumbs'
    has_attachment :storage => :s3, :path_prefix => 'content/thumbs', :max_size => 10.megabytes, :processor => :MiniMagick
    validates_as_attachment

    def parent
      self.parent_id ? Image.find(self.parent_id) : nil
    end
