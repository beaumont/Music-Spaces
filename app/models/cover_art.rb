...
class CoverArt < Image
  #TODO: this needs refactoring. We should extract relationship of CoverArts to contents to some new table and make
  #  the association polymorphic.  
  belongs_to :art_for_downloadable, :class_name => BasicFolderWithDownloadables.name, :foreign_key => 'downloadable_album_id'
  belongs_to :art_for_inbox, :class_name => Inbox.name, :foreign_key => 'downloadable_album_id'
  belongs_to :host_content, :class_name => 'Content', :foreign_key => 'downloadable_album_id'
end
